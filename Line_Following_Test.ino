...
QTRSensorsRC qtrrc((unsigned char[]) {PF_3,PB_3,PC_4,PC_5,PC_6,PC_7,PD_6,PD_7},NUM_SENSORS, TIMEOUT, EMITTER_PIN); 
...
int pwm_a = PE_4;  //PWM control for Ardumoto outputs A1 and A2 is on digital pin 10  (Left motor)
int pwm_b = PE_5;  //PWM control for Ardumoto outputs B3 and B4 is on digital pin 11  (Right motor)
int dir_a = PB_4;  //direction control for Ardumoto outputs A1 and A2 is on digital pin 12  (Left motor)
int dir_b = PA_5;  //direction control for Ardumoto outputs B3 and B4 is on digital pin 13  (Right motor)
